...
public class Configuration {
	...
	private String[] room3 = {"17:17:1717", "18:18:1818", "19:19:1919"};
	...
	private String[] pat2 = {"12:12:1212", "13:13:1313", "14:14:1414", "15:15:1515", "16:16:1616"};

	private String uri_base_prefix = "coap://[aaaa::212:74";
	private String uri_base_suffix = "]:5683/id";
	
	public void simulation9() {
		...
		for (int i = 0; i < room3.length; i++) {
			String message = "e=" + String.valueOf(3);
			String address = uri_base_prefix + room3[i] + uri_base_suffix;
			System.out.println(address);
			CoapClient mote_c = new CoapClient(address);
			mote_c.setTimeout(0);
			CoapResponse post_response = mote_c.post(message,MediaTypeRegistry.TEXT_PLAIN);
